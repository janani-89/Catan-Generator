...
const CenterDesert = ({shuffledResource, numberPool, reload}) => {
  ...
  return(
    shuffledResource && shuffledResource.map((res, index) => {
      return (
        <View style={styles.container} key={index} >
          <View style={styles.imageView}>
            {renderResourceImage(res, numberPool[0])}
            {renderResourceImage(res, numberPool[1])}
            {renderResourceImage(res, numberPool[2])}
          </View>
          <View style={styles.imageView}>
            {renderResourceImage(res, numberPool[3])}
            {renderResourceImage(res, numberPool[4])}
            {renderResourceImage(res, numberPool[5])}
            {renderResourceImage(res, numberPool[6])}
          </View>
          <View style={styles.imageView}>
            {renderResourceImage(res, numberPool[7])}
            {renderResourceImage(res, numberPool[8])}
            {renderResourceImage(res, numberPool[9])}
            {renderResourceImage(res, numberPool[10])}
            {renderResourceImage(res, numberPool[11])}
          </View>
          <View style={styles.imageView}>
            {renderResourceImage(res, numberPool[12])}
            {renderResourceImage(res, numberPool[13])}
            {renderResourceImage(res, numberPool[14])}
            {renderResourceImage(res, numberPool[15])}
          </View>
          <View style={styles.imageView}>
            {renderResourceImage(res, numberPool[16])}
            {renderResourceImage(res, numberPool[17])}
            {renderResourceImage(res, numberPool[18])}
          </View>
        </View>
      )
    })
